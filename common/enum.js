...
export const KeyboardKeyCodes = {
    ...
    KeyA: new KeyboardKeyCode('KeyA', 'a'),
    KeyB: new KeyboardKeyCode('KeyB', 'b'),
    KeyC: new KeyboardKeyCode('KeyC', 'c'),
    KeyD: new KeyboardKeyCode('KeyD', 'd'),
    KeyE: new KeyboardKeyCode('KeyE', 'e'),
    ...
    KeyT: new KeyboardKeyCode('KeyT', 't'),
    ...
    ArrowLeft: new KeyboardKeyCode('ArrowLeft', 'ArrowLeft', 37, 37),
    ArrowRight: new KeyboardKeyCode('ArrowRight', 'ArrowRight', 39, 39),
    ArrowUp: new KeyboardKeyCode('ArrowUp', 'ArrowUp', 38, 38),
    ArrowDown: new KeyboardKeyCode('ArrowDown', 'ArrowDown', 40, 40),
    ...
    Digit4: new KeyboardKeyCode("Digit4", "4"),
    Digit5: new KeyboardKeyCode("Digit5", "5"),
    Digit6: new KeyboardKeyCode("Digit6", "6"),
    Digit7: new KeyboardKeyCode("Digit7", "7"),
    Digit8: new KeyboardKeyCode("Digit8", "8"),
    Digit9: new KeyboardKeyCode("Digit9", "9"),
